...
CREATE TABLE `customer_table` (
  ...
  CONSTRAINT `customer_id` FOREIGN KEY (`customer_id`) REFERENCES `user_table` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `customer_table` VALUES (12,'12345678'),(14,'12345678'),(16,'12345678');
