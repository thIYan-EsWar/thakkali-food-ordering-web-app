...
CREATE TABLE `manager_table` (
  ...
  CONSTRAINT `manager_id` FOREIGN KEY (`manager_id`) REFERENCES `user_table` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `manager_table` VALUES (13,'1234567890','Lux','Los Angeles'),(15,'1234567890','Boar Hat','Mother of Creation');
...
-- Dump completed on 2022-02-09 16:40:26
